...
HD_PWD='C:/Users/Diego/Documents/Fiuna/LME/Link test/AC701/test_clk_gen/test_clk_gen.runs/fifo_generator_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_generator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_generator.tcl
