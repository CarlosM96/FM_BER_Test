...
HD_PWD='C:/Users/Diego/Documents/Fiuna/LME/Link test/AC701/sfp_test_1/sfp_test_1.runs/fifo_fm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_fm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_fm.tcl
