...
#
# Generated by export_simulation on Wed Dec 09 15:02:16 -03 2020
#
################################################################################
...
'-reset_run' switch to the './RX_vc709.sh' script.

./RX_vc709.sh -reset_run
...
./RX_vc709.sh -noclean_files

For more information on the script, please type './RX_vc709.sh -help'.
