...
HD_PWD='/home/daphnelme/Desktop/CarlosPrueba/GTH_RX_SIM_Folder/GTH_RX_VC709/GTH_RX_VC709.runs/TX_GTH_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TX_GTH.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TX_GTH.tcl
